...
const ListaPacientesSA = () => {
  ...
  const establecimientosDisponibles = useMemo(() => {
    return [
      ...new Set(pacientes.map((p) => p.nombreEstablecimiento).filter(Boolean)),
    ].sort();
  }, [pacientes]);
      ...
      <div className="personal-page">
        <div className="personal-header-simple">
          <div>
            ...
            <p>Visualiza y filtra los pacientes registrados en el sistema.</p>
          </div>
          <button
            className="btn-add-top"
            onClick={() => navigate("/añadir-pacienteSA")}
          >
            + Registrar paciente
          </button>
        </div>
                    ...
                    <tr key={p.idPersona}>
                      ...
                      <td>
                        <span className="establishment-chip">
                          {p.nombreEstablecimiento || "Sin establecimiento"}
                        </span>
                      </td>
...
export default ListaPacientesSA;