...
const Header = () => {
  ...
  const navItems = [
    ...
    { path: "/lista-personal-saludSA", label: "Personal Salud" },
    { path: "/lista-pacientesSA", label: "Pacientes" },
    { path: "/seguimiento-tratamientosSA", label: "Seguimiento" },
    { path: "/transferenciaSA", label: "Transferencia" },
    { path: "/videosSA", label: "Videos" },
  ];
    ...
    <header className="header">
      <nav className="custom-navbar">
        <div className="navbar-left">
          <Link className="navbar-brand" to="/homesa">
