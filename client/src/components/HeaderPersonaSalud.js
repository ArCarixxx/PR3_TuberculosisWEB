...
const Header = () => {
  ...
  const navItems = [
    { path: "/lista-pacientesPS", label: "Pacientes" },
    { path: "/seguimiento-tratamientos", label: "Seguimiento" },
    { path: "/transferenciaPS", label: "Transferencia" },
    { path: "/videosPS", label: "Videos" },
  ];
    ...
    <header className="header">
      <nav className="custom-navbar">
        ...
        <div className="navbar-left">
          <Link className="navbar-brand" to="/homeps">
